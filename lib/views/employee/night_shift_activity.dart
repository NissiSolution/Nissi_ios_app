...
class NightShiftPage extends StatefulWidget {
  const NightShiftPage({super.key});

  @override
  State<NightShiftPage> createState() => _NightShiftPageState();
}

class _NightShiftPageState extends State<NightShiftPage> {
  ...
  late int type;
  late List<CompOffHoliday> nightShiftList = [];
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    if (state == AppLifecycleState.resumed) {
      // This is where you can do your tasks upon app resume
      getRequestData();
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: Constants.appBar(Constants.nightShift),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ListView.builder(
                            itemCount: Filter().filterCompOffHoliday(nightShiftList, type).length,
                                  ...
                                  onPressed: () {
                                    Navigator.of(context).push(
                                        MaterialPageRoute(builder: (context) => UniqueCompOffHolidayPage(
                                            data: Filter().filterCompOffHoliday(nightShiftList, type)[index].theData,
                                            requestType: Filter().filterCompOffHoliday(nightShiftList, type)[index].requestType),
                                        )
                                    );
                                  },
                                  child: Container(
                                    decoration: Constants.statusDecoration(Filter().filterCompOffHoliday(nightShiftList, type)[index].status),
                                      ...
                                      children: <Widget>[
                                        ...
                                        Row(
                                          ...
                                          children: [
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    if (int.parse(Filter().filterCompOffHoliday(nightShiftList, type)[index].requestType) == 3)
                                                      SizedBox(
                                                        width: textWidth,
                                                        child: Text(
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                        width: textWidth,
                                                        child: Text(
                                                          Filter().filterCompOffHoliday(nightShiftList, type)[index].date,
                                                          style: Constants.textStyle1(Constants.signature), overflow: TextOverflow.ellipsis, maxLines: 2,))
                                                  ],
                                                ),
                                                const SizedBox(height: 5.0),
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                        width: textWidth,
                                                        child: Text(
                                                          supports.getStatus(Filter().filterCompOffHoliday(nightShiftList, type)[index].status),
                                                          style: Constants.textStyle1(Constants.signature), overflow: TextOverflow.ellipsis, maxLines: 2,)),
                                            ...
                                            const SizedBox(width: 10.0,),
                                            if (Filter().filterCompOffHoliday(nightShiftList, type)[index].status == 0)
                                              IconButton(
                                                  onPressed: () {
                                                    deleteData(Filter().filterCompOffHoliday(nightShiftList, type)[index].id, index);
  ...
  void getRequestData() async {
    ...
    Map<String, String> data = {
      Constants.requestType : Constants.getNightShift,
