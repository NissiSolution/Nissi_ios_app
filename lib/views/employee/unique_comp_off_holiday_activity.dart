...
class UniqueCompOffHolidayPage extends StatefulWidget {
  UniqueCompOffHolidayPage({
    required this.data,
  ...
  @override
  State<UniqueCompOffHolidayPage> createState() => _UniqueCompOffHolidayPageState();
}

class _UniqueCompOffHolidayPageState extends State<UniqueCompOffHolidayPage> {

  late String? requestType = Constants.leaveType, requestDate = Constants.purpose,
      requestedOn = Constants.requestedOn, reason = Constants.reasonC,
  ...
  void setInitial() async {
    if (int.parse(requestType!) == 1) {
      title = Constants.compOff;
    } else if (int.parse(requestType!) == 2) {
      title = Constants.localHoliday;
    } else if (int.parse(requestType!) == 3) {
