...
class UniqueAdminMissedPunchPage extends StatefulWidget {
  UniqueAdminMissedPunchPage({
    required this.data,
    super.key});
  ...
  @override
  State<UniqueAdminMissedPunchPage> createState() => _UniqueAdminMissedPunchPageState();
}

class _UniqueAdminMissedPunchPageState extends State<UniqueAdminMissedPunchPage> {
                    ...
                    children: [
                      ...
                      Row(
                          ...
                          children: [
                            SizedBox(
                              width: 120.0,
                              child: Text(Constants.workedPeriod, style: Constants.textStyle2(Constants.company),),
                            ),
                            Container(
                                alignment: Alignment.center,
                                width: 20.0,child: Text(Constants.colan, style: Constants.textStyle2(Constants.company),)),
  ...
  void declareItem() {
    ...
    reason = list1[4];
    position = list1[7];
    workedHour = "From ${list1[9]} to ${list1[10]}";
    empId = list1[8];
    rejectedReason = list1[11];
