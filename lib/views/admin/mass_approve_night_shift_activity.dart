...
class MassApproveNightShiftPage extends StatefulWidget {
  const MassApproveNightShiftPage({super.key});

  @override
  State<MassApproveNightShiftPage> createState() => _MassApproveNightShiftPageState();
}

class _MassApproveNightShiftPageState extends State<MassApproveNightShiftPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text(Constants.nightShiftRequest),
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              return TextButton(
                                  ...
                                  onPressed: () {
                                    if (adminCompOffHolidayList[index].isChecked) {
                                      adminCompOffHolidayList[index].isChecked = false;
                                    } else {
                                      adminCompOffHolidayList[index].isChecked = true;
                                    }
                                    setState(() {
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                        alignment: Alignment.center,
                                                        width: 20.0,child: Text(Constants.colan, style: Constants.textStyle2(Constants.company),)),
                                                    if (int.parse(adminCompOffHolidayList[index].requestType) == 3)
                                                      SizedBox(
                                                          width: textWidth2,
                                                          child: Text(
