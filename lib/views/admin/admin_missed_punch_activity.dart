...
import '/views/admin/unique_admin_missed_punch.dart';
...
import 'mass_approve_missed_punch_activity.dart';

class AdminMissedPunchPage extends StatefulWidget {
  const AdminMissedPunchPage({super.key});

  @override
  State<AdminMissedPunchPage> createState() => _AdminMissedPunchPageState();
}

class _AdminMissedPunchPageState extends State<AdminMissedPunchPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: Constants.appBar(Constants.missedPunchRequest),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: ListView.builder(
                            itemCount: Filter().filterAdminMissedPunch(adminMissedPunchList, type).length,
                            itemBuilder: (BuildContext context, int index) {
                              return TextButton(
                                  style: Constants.buttonStyle2(Constants.company),
                                  onPressed: () {
                                    uniqueApprove(context, Filter().filterAdminMissedPunch(adminMissedPunchList, type)[index].theData);
                                  },
                                  onLongPress: () {
                                    if (Filter().filterAdminMissedPunch(adminMissedPunchList, type)[index].status == 0) {
                                      massApprove(context);
                                    }
                                  },
                                  child: Container(
                                    decoration: Constants.statusDecoration(Filter().filterAdminMissedPunch(adminMissedPunchList, type)[index].status),
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                        width: textWidth2,
                                                        child: Text(
                                                          Filter().filterAdminMissedPunch(adminMissedPunchList, type)[index].staffName,
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                        width: textWidth2,
                                                        child: Text(
                                                          Filter().filterAdminMissedPunch(adminMissedPunchList, type)[index].period,
                                                          style: Constants.textStyle1(Constants.signature), overflow: TextOverflow.ellipsis, maxLines: 2,))
                                                  ],
                                                ),
                                                const SizedBox(height: 5.0),
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                        width: textWidth2,
                                                        child: Text(
                                                          Filter().filterAdminMissedPunch(adminMissedPunchList, type)[index].date,
                                                          style: Constants.textStyle1(Constants.signature), overflow: TextOverflow.ellipsis, maxLines: 2,)),
                                                  ],
                                                ),
                                                const SizedBox(height: 5.0),
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                        width: textWidth2,
                                                        child: Text(
                                                          supports.getStatus(Filter().filterAdminMissedPunch(adminMissedPunchList, type)[index].status),
                                                          style: Constants.textStyle1(Constants.signature), overflow: TextOverflow.ellipsis, maxLines: 2,)),
                                                  ],
                                                )
                                              ],
  ...
  Future<void> uniqueApprove(BuildContext context, String theData) async {
    // Navigator.push returns a Future that completes after calling
    // Navigator.pop on the Selection Screen.
    final result = await Navigator.push(
        context,
        // Create the SelectionScreen in the next step.
        MaterialPageRoute(builder: (context) => UniqueAdminMissedPunchPage(
          data: theData)
        )
  ...
  Future<void> massApprove(BuildContext context) async {
    ...
    final result = await Navigator.push(
        context,
        // Create the SelectionScreen in the next step.
        MaterialPageRoute(builder: (context) => const MassApproveMissedPunchPage()
        )
    );
  ...
  void updateViewed() async {
    Map<String, String> data = {
      ...
      Constants.staffId     : staffId,
      Constants.type        : Constants.key110,
    };
    var client = Client();
    var response;
    try {
